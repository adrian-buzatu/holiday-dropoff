...
<div>
    <div>
        ...
        <?php if ($success == false): ?>
            <form method="post" action="<?php echo base_url()?>videos/edit/<?php echo $id?>" enctype="multipart/form-data">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="form_banner_image">
                                <input type="text" name="src" value="<?php echo set_value('src') == '' ? $banner['src'] :set_value('src')?>">
                            </td>
                            <td colspan="2">
                                <?php if (isset($error)): ?>
        ...
        <?php else:?>
            <div>Gallery Video updated successfully.</div>
        <?php endif;?>
    </div>
</div>
