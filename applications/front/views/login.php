                ...
                <tr>
                    <td style="padding-left:20px; padding-top:50px;"><table width="610" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td><input id="username" name="username" type="text"  class="useriputbg" onkeypress="return submitfrm(event);" /></td>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><input id="password" name="username" type="password"  class="useriputbg" /></td>
                            ...
                            <tr>
                                <td colspan="2">&nbsp;</td>
                                <td colspan="4" class="loginbt"><font style="cursor:pointer; color:white">Submit</font>
